...
describe('MinorCreditor Mapper build correctly', () => {
    test('should construct distinct minor creditor details', () => {
        ...
        expect(minorCreditor[0].minorCreditorAddress1).toBe("line1");
        expect(minorCreditor[0].minorCreditorAddress2).toBe("line2");
        expect(minorCreditor[0].minorCreditorAddress3).toBe("line3");
        expect(minorCreditor[0].minorCreditorAddress4).toBe("line4");
        expect(minorCreditor[0].minorCreditorAddress5).toBe("line5");
