...
describe('OffenceMapper builds correctly', () => {
    test('build offence with all values', () => {
        ...
        expect(results[0].wording).toBe('On 21/10/2018 at Euston Train Station, London robbed Alyssa Hill of her Mangalsutra.####Offence Legislation 1');
        ...
        expect(results[1].wording).toBe('wordinggggggggg####Offence Legislation 2');
    });
});
