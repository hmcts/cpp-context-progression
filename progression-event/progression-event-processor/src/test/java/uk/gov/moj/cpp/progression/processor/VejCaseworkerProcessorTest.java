...
public class VejCaseworkerProcessorTest {
    ...
    private static final String VEJ_HEARING_DETAILS_URL = "https://dummyUrl/vej/api/v1/hearing/details";
    private static final String VEJ_HEARING_DELETED_URL = "https://dummyUrl/vej/api/v1/hearing/deleted";
    ...
    public void shouldProcessVejHearingPopulatedToProbationCaseworker() throws IOException {
        ...
        final JsonReader jsonReader = createReader(new StringReader(argumentCaptor));
