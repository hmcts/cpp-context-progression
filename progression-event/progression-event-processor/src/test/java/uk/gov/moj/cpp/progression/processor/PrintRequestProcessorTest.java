...
public class PrintRequestProcessorTest {
    ...
    @InjectMocks
    private PrintRequestProcessor printRequestProcessor;
    ...
    public void shouldPrintResultOrder() throws Exception {
        ...
        printRequestProcessor.printDocument(event);

        verify(notificationNotifyService).sendLetterNotification(event, notificationId, materialId);
        verify(printService).recordPrintRequestAccepted(event);
    }
