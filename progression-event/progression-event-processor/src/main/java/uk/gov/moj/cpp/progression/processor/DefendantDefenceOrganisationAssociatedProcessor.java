...
public class DefendantDefenceOrganisationAssociatedProcessor {
    ...
    private static final String PROGRESSION_COMMAND_HANDLER_ASSOCIATE_DEFENCE_ORGANISATION_FOR_LAA = "progression.command.handler.associate-defence-organisation-for-laa";
    ...
    public void processEvent(final JsonEnvelope event) {
        ...
        sender.send(
                Enveloper.envelop(event.payloadAsJsonObject())
                        .withName(PROGRESSION_COMMAND_HANDLER_ASSOCIATE_DEFENCE_ORGANISATION_FOR_LAA)
