...
public class HearingResultsDocumentSubscriptionPCRException extends RuntimeException {

    public HearingResultsDocumentSubscriptionPCRException(final UUID fileId, final UUID materialId, final String prisonCourtRegisterId, final String url) {
