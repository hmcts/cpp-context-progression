...
public class SummonsService {
    ...
    private void generateSummonsCourtDocument(JsonEnvelope jsonEnvelope, CourtApplication courtApplication, SummonsDocumentContent summonsDocumentContent, UUID applicationId) {
        ...
        final CourtDocument courtDocument = createApplicationDocument(courtApplication, materialId);
    ...
    private JsonObject getCourtCentreFromReferenceData(final JsonEnvelope jsonEnvelope, final UUID courtCentreId) {
        final Optional<JsonObject> courtCentreJsonOptional = referenceDataService.getOrganisationUnitById(courtCentreId, jsonEnvelope);
        return courtCentreJsonOptional.orElseThrow(IllegalArgumentException::new);
    }

    private CourtDocument createApplicationDocument(final CourtApplication courtApplication, final UUID materialId) {
    ...
    private static boolean validTemplateType(ApplicationSummonsTemplateType summonsTemplateType) {
        try {
    ...
    private static boolean respondentsPresent(CourtApplication courtApplication){
