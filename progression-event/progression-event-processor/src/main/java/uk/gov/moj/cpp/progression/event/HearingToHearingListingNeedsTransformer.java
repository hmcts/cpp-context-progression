...
public class  HearingToHearingListingNeedsTransformer {
    ...
    private void addProsecutionCase(final HearingListingNeeds hearingListingNeeds, final ProsecutionCase prosecutionCase, final Defendant defendant, final Offence offence) {
        ...
        final ProsecutionCase prosecutionCaseInNeeds = getOrCreateProsecutionCase(hearingListingNeeds, prosecutionCase);
        final Defendant defendantInNeeds = getOrCreateDefendant(prosecutionCaseInNeeds, defendant);
        getOrCreateOffence(defendantInNeeds, offence);

    }

    private ProsecutionCase getOrCreateProsecutionCase(final HearingListingNeeds hearingListingNeeds, final ProsecutionCase prosecutionCase){
    ...
    private Defendant getOrCreateDefendant(final ProsecutionCase prosecutionCaseInNeeds, final Defendant defendant){
    ...
    private Offence getOrCreateOffence(final Defendant defendantInNeeds, final Offence offence){
