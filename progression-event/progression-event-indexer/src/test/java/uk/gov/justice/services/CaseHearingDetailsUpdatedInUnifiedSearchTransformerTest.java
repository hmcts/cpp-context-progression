...
public class CaseHearingDetailsUpdatedInUnifiedSearchTransformerTest {
    ...
    @InjectMocks
    private CaseHearingDetailsUpdatedInUnifiedSearchTransformer caseHearingDetailsUpdatedInUnifiedSearchTransformer;
    ...
    public void shouldTransformDefendantsListingStatusChangedTransformer() throws IOException {
        ...
        final JsonObject output = objectToJsonObjectConverter.convert(caseHearingDetailsUpdatedInUnifiedSearchTransformer.transform(input));
        ...
        hearingVerificationHelper.verifyCounts(3, 4, 0);
    }
    ...
    public void shouldTransformDefendantsListingStatusChangedWithLinkedApplication() throws IOException {
        ...
        hearingVerificationHelper.verifyHearings(inputDC, output, 0, 0);
        hearingVerificationHelper.verifyCounts(0, 1, 0);
    }
}