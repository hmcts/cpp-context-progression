...
public class CourtApplicationSubjectCustodialInformationUpdatedEventListenerTest {
    ...
    public void testSubjectCustodialInformationUpdatedWhenRemoved() {
        ...
        Assert.assertEquals("Check if the custody establishment is  removed",true, applicationNode.findPath("custodialEstablishment").isMissingNode());
    }
    ...
    public void testSubjectCustodialInformationUpdatedWhenAdded() {
        ...
        final ObjectMapper mapper = new ObjectMapperProducer().objectMapper();
        final JsonNode applicationNode = mapper.valueToTree(JSONValue.parse(updatedApplicationEntiry.getPayload()));
        Assert.assertEquals("Check if the custody establishment is  added","Police", applicationNode.findPath("custodialEstablishment").path("custody").asText());
        Assert.assertEquals("Check if the custody establishment is  added","Custody", applicationNode.findPath("custodialEstablishment").path("name").asText());
    ...
    public void testSubjectCustodialInformationUpdatedWhenUpdated() {
        ...
        final ObjectMapper mapper = new ObjectMapperProducer().objectMapper();
        final JsonNode applicationNode = mapper.valueToTree(JSONValue.parse(updatedApplicationEntiry.getPayload()));
        Assert.assertEquals("Check if the custody establishment is  added","Police1", applicationNode.findPath("custodialEstablishment").path("custody").asText());
        Assert.assertEquals("Check if the custody establishment is  added","Custody1", applicationNode.findPath("custodialEstablishment").path("name").asText());
