...
class ApplicationRepOrderOffencesUpdatedEventListenerTest {
    ...
    @Captor
    private ArgumentCaptor<InitiateCourtApplicationProceedings> initiateCourtApplicationProceedingsArgumentCaptor;
    ...
    @InjectMocks
    private ApplicationRepOrderOffencesUpdatedEventListener listener;
    ...
    @Test
    void shouldHandleApplicationOffencesUpdated() {
        ...
        ApplicationReporderOffencesUpdated applicationOffencesUpdated = ApplicationReporderOffencesUpdated.applicationReporderOffencesUpdated()
        ...
        listener.processApplicationRepOrderOffencesUpdated(envelope);
        ...
        assertThat(courtApplication1.getCourtApplicationCases().size(), is(3));
