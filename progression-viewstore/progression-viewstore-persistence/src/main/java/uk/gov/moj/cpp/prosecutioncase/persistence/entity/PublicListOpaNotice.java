...
@Entity
@Table(name = "public_list_opa_notice")
public class PublicListOpaNotice implements Serializable {
    ...
    public PublicListOpaNotice() {
    }

    public PublicListOpaNotice(final UUID caseId,
