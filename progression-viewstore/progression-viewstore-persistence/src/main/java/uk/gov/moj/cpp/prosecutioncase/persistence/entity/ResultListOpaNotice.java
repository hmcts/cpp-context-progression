...
@Entity
@Table(name = "result_list_opa_notice")
public class ResultListOpaNotice implements Serializable {
    ...
    public ResultListOpaNotice() {
    }

    public ResultListOpaNotice(final UUID caseId,
