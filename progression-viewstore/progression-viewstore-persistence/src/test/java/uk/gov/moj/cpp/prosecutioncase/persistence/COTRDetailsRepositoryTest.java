...
public class COTRDetailsRepositoryTest {
    ...
    public void shouldFindCotrDetailsByHearingId() {
        ...
        COTRDetailsEntity entity2 = new COTRDetailsEntity(cotrId2, hearingId2, prosecutionCaseId, isArchived, prosecutionFormData, caseProgressionReviewNote, listingReviewNotes, judgeReviewNotes);
