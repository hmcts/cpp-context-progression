...
public class UpdateBailStatusForDefendantHelper extends AbstractTestHelper {
    ...
    private static final String TEMPLATE_UPDATE_BAIL_PAYLOAD =
                    "raml/json/progression.command.update-bail-status-for-defendant.json";
    ...
    public UpdateBailStatusForDefendantHelper(String caseId, String defendantId) {
        this.caseId=caseId;
        this.defendantId = defendantId;
        privateEventsConsumer = QueueUtil.privateEvents.createConsumer(EVENT_SELECTOR_BAIL_STATUS_UPDATED_FOR_DEFENDANT);
    }
    ...
    public void updateBailStatus() {
        String jsonString = getPayload(TEMPLATE_UPDATE_BAIL_PAYLOAD);
    ...
    public void verifyInActiveMQ() {
        ...
        assertThat(jsonResponse.get("bailStatus"), equalTo(jsRequest.get("bailStatus")));
    }

    public void verifyBailStatusUpdated() {
        JsonPath jsRequest = new JsonPath(request);
