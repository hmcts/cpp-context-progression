...
public class NowsDocumentRequestHelper extends AbstractTestHelper {
    ...
    public NowsDocumentRequestHelper() {
        privateEventsConsumer = newPrivateJmsMessageConsumerClientProvider(ContextNameProvider.CONTEXT_NAME).withEventNames(EVENT_SELECTOR_PRISON_COURT_REGISTER_DOCUMENT_REQUEST_RECORDED).getMessageConsumerClient();
        privateEventsConsumer2 = newPrivateJmsMessageConsumerClientProvider(ContextNameProvider.CONTEXT_NAME).withEventNames(EVENT_SELECTOR_PRISON_COURT_REGISTER_DOCUMENT_REQUEST_GENERATED).getMessageConsumerClient();
