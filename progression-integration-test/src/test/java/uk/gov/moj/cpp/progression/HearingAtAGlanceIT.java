        ...
        poll(requestParams(getReadUrl("/prosecutioncases/" + caseId), PROGRESSION_QUERY_PROSECUTION_CASE_CAAG_JSON)
                ...
                .until(
                        ...
                        payload().isJson(allOf(
                                withJsonPath("$.defendants[0].caagDefendantOffences[0].caagResults[0].resultText", equalTo("resultText")),
                                withJsonPath("$.defendants[0].defendantJudicialResults[0].resultText", equalTo("Surcharge Amount of surcharge £50")),
