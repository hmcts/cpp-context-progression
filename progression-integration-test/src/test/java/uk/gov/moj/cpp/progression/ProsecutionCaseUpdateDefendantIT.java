...
public class ProsecutionCaseUpdateDefendantIT extends AbstractIT {
    ...
    public void shouldUpdateMatchedOtherDefendantsDetails_WithCustodyEstablishment_WhenThreeCasesAreRelatedToDefendant() throws Exception {
        ...
        final JmsMessageConsumerClient publicEventConsumerForProsecutionCaseCreated3 = newPublicJmsMessageConsumerClientProvider().withEventNames("public.progression.prosecution-case-created").getMessageConsumerClient();
        ...
        messageProducerClientPublic.sendMessage(PUBLIC_LISTING_HEARING_CONFIRMED, publicEventEnvelope);
        verifyInMessagingQueueForProsecutionCaseCreated(publicEventConsumerForProsecutionCaseCreated3);
        ...
        final JmsMessageConsumerClient publicEventConsumerForDefendantUpdated2 = newPublicJmsMessageConsumerClientProvider().withEventNames("public.progression.case-defendant-changed").getMessageConsumerClient();
        ...
        prosecutionCaseMatchers = getProsecutionCaseMatchers(matchedCaseId_3, matchedDefendant_3, emptyList());
        pollProsecutionCasesProgressionFor(matchedCaseId_3, prosecutionCaseMatchers);
        verifyInMessagingQueueForDefendantUpdated(publicEventConsumerForDefendantUpdated2);
