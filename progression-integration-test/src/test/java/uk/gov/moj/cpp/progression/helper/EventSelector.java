...
public class EventSelector {
    ...
    public static final String EVENT_SELECTOR_DEFENCE_DISASSOCIATION_FOR_DEFENDANT = "public.defence.defence-organisation-disassociated";
    ...
    public static final String EVENT_RECORD_NOWS_MATERIAL_REQUEST = "progression.command.record-nows-material-request";
