...
public class HearingResultedIT {
    ...
    private static final JmsMessageConsumerClient messageConsumerHearingDefendantUpdated = newPrivateJmsMessageConsumerClientProvider(CONTEXT_NAME).withEventNames("progression.event.hearing-defendant-updated").getMessageConsumerClient();
    ...
    public void shouldAddTheCaseToUnAllocatedHearingWhenHearingExtendedToUnAllocatedHearing() throws IOException {
        ...
        hearingId3 = retrieveMessageAsJsonPath(messageConsumerProsecutionCaseDefendantListingStatusChanged, isJson(CoreMatchers.allOf(
                withJsonPath("$.hearing.prosecutionCases[0].id", is(caseId)),
                withJsonPath("$.hearing.id", not(is(hearingId)))
        ))).getJsonObject("hearing.id");
        ...
        final JsonPath event= retrieveMessageAsJsonPath(messageConsumerProsecutionCaseDefendantListingStatusChanged, isJson(CoreMatchers.allOf(
                withJsonPath("$.hearing.prosecutionCases[0].id", is(caseId)),
    ...
    public void shouldAddTheNewOffenceToUnAllocatedHearingWhenOffenceAddedToCase() throws JSONException, IOException {
        ...
        hearingId2 = retrieveMessageAsJsonPath(messageConsumerProsecutionCaseDefendantListingStatusChanged, isJson(CoreMatchers.allOf(
                withJsonPath("$.hearing.prosecutionCases[0].id", is(caseId)),
                withJsonPath("$.hearing.id", not(is(hearingId)))
        ))).getJsonObject("hearing.id");
        ...
        final JmsMessageConsumerClient  messageConsumerAllHearingOffencesUpdated = newPrivateJmsMessageConsumerClientProvider(CONTEXT_NAME).withEventNames("progression.event.all-hearing-offences-updated-v2").getMessageConsumerClient();
        ...
        helper.verifyInActiveMQ(newPrivateJmsMessageConsumerClientProvider(CONTEXT_NAME).withEventNames("progression.event.prosecution-case-offences-updated").getMessageConsumerClient());
        ...
        final JsonPath message = retrieveMessageAsJsonPath(messageConsumerAllHearingOffencesUpdated, isJson(CoreMatchers.allOf(
                withJsonPath("$.defendantId", is(defendantId)),
                withJsonPath("$.hearingIds.length()", is(2)))));
    ...
    private String createHearing(final String caseId, final String defendantId) throws IOException {
        ...
        hearingId =retrieveMessageAsJsonPath(messageConsumerProsecutionCaseDefendantListingStatusChanged, isJson(CoreMatchers.allOf(withJsonPath("$.hearing.prosecutionCases[0].id", is(caseId))))).getJsonObject("hearing.id");
        ...
        verifyInMessagingQueueForCasesReferredToCourts();
        verifyInMessagingQueueForDefendantUpdated(hearingId);
    ...
    public void verifyInMessagingQueueForDefendantUpdated(final String hearingId) {
        final JsonPath message = retrieveMessageAsJsonPath(messageConsumerHearingDefendantUpdated, isJson(CoreMatchers.allOf(withJsonPath("$.hearingId", is(hearingId)))));
