...
import uk.gov.moj.cpp.results.domain.transformation.util.TransformationEventHelper;
...
@Transformation
public class PrgressionEventTransformer implements EventTransformation {
    ...
    private static final Logger LOGGER = getLogger(PrgressionEventTransformer.class);
