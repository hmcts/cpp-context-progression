...
public class ProgressionMOTEventTransformer implements EventTransformation {
    ...
    public static final String PROGRESSION_EVENT_COURT_APPLICATION_ADDED_TO_CASE = "progression.event.court-application-added-to-case";
    ...
    public Action actionFor(final JsonEnvelope event) {
        ...
        if (name.equalsIgnoreCase(EVENT_PROGRESSION_HEARING_RESULTED)
                ...
                || name.equalsIgnoreCase(PROGRESSION_EVENT_COURT_APPLICATION_ADDED_TO_CASE)) {
            return TRANSFORM;
        }
        return NO_ACTION;
    }
    ...
    public Stream<JsonEnvelope> apply(final JsonEnvelope event) {
        ...
        }else if (name.equalsIgnoreCase(PROGRESSION_EVENT_COURT_APPLICATION_ADDED_TO_CASE)) {
            transformedEvent = new TransformationEventHelper().buildCourtApplicationPayLoad(event, PROGRESSION_EVENT_COURT_APPLICATION_ADDED_TO_CASE);
        }
