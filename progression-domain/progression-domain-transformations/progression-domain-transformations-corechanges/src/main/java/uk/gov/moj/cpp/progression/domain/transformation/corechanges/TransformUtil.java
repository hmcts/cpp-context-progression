...
public class TransformUtil {
    ...
    public static JsonObjectBuilder cloneWithPathFilter(final JsonObject jsonObject, final BiFunction<JsonValue, Deque<String>, Object> filter) {
        return cloneObjectWithPathFilter(jsonObject, filter, new ArrayDeque<>());
    }

    public static JsonArrayBuilder cloneArrayWithPathFilter(final JsonArray jsonArray, final BiFunction<JsonValue, Deque<String>, Object> filter, final Deque<String> path) {
    ...
    public static JsonObjectBuilder cloneObjectWithPathFilter(final JsonObject jsonObject, final BiFunction<JsonValue, Deque<String>, Object> filter) {
        return cloneObjectWithPathFilter(jsonObject, filter, new ArrayDeque<>());
    }

    public static JsonObjectBuilder cloneObjectWithPathFilter(final JsonObject jsonObject, final BiFunction<JsonValue, Deque<String>, Object> filter, final Deque<String> path) {
