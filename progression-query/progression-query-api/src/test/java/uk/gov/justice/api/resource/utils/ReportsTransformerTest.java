...
public class ReportsTransformerTest {
    ...
    private static void assertAttendanceDays(final List<AttendanceDayAndType> attendanceDays) {
        ...
        attendanceDays.forEach(ad -> anyOf(is(ReportsTransformer.PRESENT_BY_POLICE_VIDEO_LINK),
                is(ReportsTransformer.PRESENT_BY_PRISON_VIDEO_LINK),
                is(ReportsTransformer.PRESENT_BY_VIDEO_DEFAULT),
                is(ReportsTransformer.PRESENT_IN_PERSON)));
    }
