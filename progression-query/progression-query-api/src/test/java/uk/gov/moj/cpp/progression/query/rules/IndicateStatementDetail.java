...
public class IndicateStatementDetail extends BaseDroolsAccessControlTest {
    ...
    private static final String MEDIA_TYPE = "progression.query.indicatestatementsdetail";
