...
public class CaseProgressionDetailsTest extends BaseDroolsAccessControlTest {
    ...
    private static final String MEDIA_TYPE = "progression.query.caseprogressiondetail";
