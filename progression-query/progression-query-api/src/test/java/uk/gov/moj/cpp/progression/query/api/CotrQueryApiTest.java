...
public class CotrQueryApiTest {
    ...
    public void shouldReturnAllTrialHearingsWhenNoRemandStatusAndNoOverDueDirectionsSelected() throws IOException {
        ...
        when(progressionService.getHearing(any(Requester.class), any(JsonEnvelope.class), eq("82b243f8-c4d3-4790-92ef-6192db00539c"))).thenReturn(hearing1Json);
        when(progressionService.getHearing(any(Requester.class), any(JsonEnvelope.class), eq("111d2f19-89a7-4f4f-8d14-a90fd3977be4"))).thenReturn(hearing2Json);
    ...
    public void shouldGetTrialReadinessHearingDetails() throws IOException {
        ...
        when(progressionService.getHearing(any(Requester.class), any(JsonEnvelope.class), eq(hearingId))).thenReturn(hearingJson);
        ...
        when(progressionService.getPetsForCase(any(Requester.class), any(JsonEnvelope.class), any(String.class))).thenReturn(petsForDefendantPayload);
        when(progressionService.getPet(any(Requester.class), any(JsonEnvelope.class), any(String.class))).thenReturn(createObjectBuilder()
                ...
                .build());
        when(progressionService.getFormsForCase(any(Requester.class), any(JsonEnvelope.class), any(String.class))).thenReturn(ptphForDefendantPayload);
        when(progressionService.getForm(any(Requester.class), any(JsonEnvelope.class), any(String.class), any(String.class))).thenReturn(createObjectBuilder()
                .add("lastUpdated", "2021-01-13T10:15")
                .add("defendants", createArrayBuilder().add(createObjectBuilder().add("defendantId", "df73207f-3ced-488a-82a0-3fba79c2ce86").build()))
                .build());
