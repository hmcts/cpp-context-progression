...
public class ListingServiceTest {
    ...
    public void shouldSearchTrialReadinessWithClusterId() {
        ...
        JsonEnvelope responseClusterOrgUnit = buildResponseClusterOrganisationUnit();
        when(requester.requestAsAdmin(any(), eq(JsonObject.class))).thenReturn(response);
        when(referenceDataService.getCourtCentreIdsByClusterId(any())).thenReturn(responseClusterOrgUnit);
