...
class CaseMaterialApiTest {
    ...
    void shouldReturnEnvelopeForBulkMaterialQuery() {
        ...
        final JsonArray materialIdsArray = createArrayBuilder()
                .add(createObjectBuilder().add("materialId", UUID.randomUUID().toString()))
                .add(createObjectBuilder().add("materialId", UUID.randomUUID().toString()))
                .build();
    ...
    void shouldPreserveEnvelopeMetadataAndPayload() {
        ...
        final JsonArray materialIdsArray = createArrayBuilder()
                .add(createObjectBuilder().add("materialId", materialId1.toString()))
                .add(createObjectBuilder().add("materialId", materialId2.toString()))
                .build();
        ...
        final JsonObject responsePayload = createObjectBuilder()
                .add("materialIds", createArrayBuilder()
    ...
    void shouldHandleEmptyMaterialIdsArray() {
        // Given
        final JsonArray emptyMaterialIdsArray = createArrayBuilder().build();
        ...
        final JsonObject responsePayload = createObjectBuilder()
                .add("materialIds", createArrayBuilder().build())
                .build();
    ...
    void shouldHandleSingleMaterialId() {
        ...
        final JsonArray materialIdsArray = createArrayBuilder()
                .add(createObjectBuilder().add("materialId", materialId.toString()))
                .build();
