...
public class HearingAtAGlanceServiceTest {
    ...
    private static final String HEARING_PAYLOAD = "{\"companyRepresentatives\":[{\"firstName\":\"Test Company representative Fn\",\"id\":\"7b083991-521a-4e11-a02d-147c3886b568\",\"lastName\":\"Test Company representative Ln\",\"position\":\"DIRECTOR\",\"title\":\"\"}],\"courtCentre\":{\"address\":{\"address1\":\"176A Lavender Hill\",\"address2\":\"London\",\"address3\":\"\",\"address4\":\"\",\"address5\":\"\",\"postcode\":\"SW11 1JU\"},\"id\":\"f8254db1-1683-483e-afb3-b87fde5a0a26\",\"name\":\"Lavender Hill Magistrates' Court\",\"roomId\":\"9e4932f7-97b2-3010-b942-ddd2624e4dd8\",\"roomName\":\"Courtroom 01\"},\"hasSharedResults\":false,\"hearingDays\":[{\"listedDurationMinutes\":1," +
    ...
    public void shouldGetAllHearingsAssociatedToACase() {
        ...
        assertThat(caseHearings.get(0).getCompanyRepresentatives().size(), is(1));
        assertThat(caseHearings.get(0).getCompanyRepresentatives().get(0).getId().toString(), is("7b083991-521a-4e11-a02d-147c3886b568"));
