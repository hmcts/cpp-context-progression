...
public class MatchedDefendantCriteriaTest {
    ...
    @Test
    public void shouldGetNextExactCriteria() {

        final MatchedDefendantCriteria matchedDefendantCriteria = new MatchedDefendantCriteria(getSampleDefendant(SAMPLE_PNC_ID, SAMPLE_CRO_NUMBER));
        ...
        assertEquals(SAMPLE_PNC_ID, jsonFirstCriteria.getString(PNC_ID));
    ...
    @Test
    public void shouldGetNextPartialCriteria() {
