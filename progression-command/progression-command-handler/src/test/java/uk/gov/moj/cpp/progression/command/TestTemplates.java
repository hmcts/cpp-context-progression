...
import static uk.gov.moj.cpp.progression.command.CoreTestTemplates.CoreTemplateArguments.toMap;
import static uk.gov.moj.cpp.progression.command.CoreTestTemplates.defaultArguments;
...
public class TestTemplates {
    ...
    public static NowDocumentRequest generateNowDocumentRequestTemplate(final UUID defendantId, final JurisdictionType jurisdictionType, boolean convicted, boolean remotePrintingRequired) {
        ...
        return NowDocumentRequest.nowDocumentRequest()
                ...
                .withIsRemotePrintingRequired(Boolean.FALSE)
    ...
    public static List<EmailChannel> emailChannelTemplate() {
        return asList(EmailChannel.emailChannel()
                ...
                EmailChannel.emailChannel()
                        .withSendToAddress("Sample of the send to address 2")
                        .withReplyToAddress("Sample of Reply to Address 2")
                        .withPersonalisation(new uk.gov.justice.core.courts.Personalisation.Builder().build())
                        .withTemplateId(UUID.randomUUID())
                    .build()
                );
