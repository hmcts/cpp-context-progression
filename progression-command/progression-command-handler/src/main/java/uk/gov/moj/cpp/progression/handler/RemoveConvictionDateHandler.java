...
public class RemoveConvictionDateHandler {
    ...
    public void handle(final Envelope<RemoveConvictionDate> envelope) throws EventStreamException {
        ...
        final EventStream eventStream = eventSource.getStreamById(removeConvictionDate.getCaseId());
        final CaseAggregate caseAggregate = aggregateService.get(eventStream, CaseAggregate.class);
        final Stream<Object> events = caseAggregate.removeConvictionDate(removeConvictionDate.getCaseId(), removeConvictionDate.getOffenceId());
