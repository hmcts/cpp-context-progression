...
public class ProgressionCommandHandler {
    ...
    public void sendToCrownCourt(final JsonEnvelope envelope) throws EventStreamException {
        Stream<Object> caseSentToCrownCourt = streamOf(progressionEventFactory.createCaseSentToCrownCourt(envelope));
    ...
    public void addDefenceIssues(final JsonEnvelope envelope) throws EventStreamException {
        Stream<Object> events = streamOf(progressionEventFactory.createDefenceIssuesAdded(envelope));
        EventStream eventStream = eventSource.getStreamById(getCaseProgressionId(envelope));
    ...
    public void sendCommittalHearingInformation(final JsonEnvelope envelope) throws EventStreamException {
        Stream<Object> events = streamOf(progressionEventFactory.createSendingCommittalHearingInformationAdded(envelope));
        EventStream eventStream = eventSource.getStreamById(getCaseProgressionId(envelope));
        eventStream.appendAfter(events.map(enveloper.withMetadataFrom(envelope)), getVersion(envelope));
    }
    ...
    public void addDefenceTrialEstimate(final JsonEnvelope envelope) throws EventStreamException {
        Stream<Object> events = streamOf(progressionEventFactory.createDefenceTrialEstimateAdded(envelope));
        EventStream eventStream = eventSource.getStreamById(getCaseProgressionId(envelope));
        eventStream.appendAfter(events.map(enveloper.withMetadataFrom(envelope)), getVersion(envelope));
    }
    ...
    public void addProsecutionTrialEstimate(final JsonEnvelope envelope) throws EventStreamException {
        Stream<Object> events = streamOf(progressionEventFactory.createProsecutionTrialEstimateAdded(envelope));
        EventStream eventStream = eventSource.getStreamById(getCaseProgressionId(envelope));
        eventStream.appendAfter(events.map(enveloper.withMetadataFrom(envelope)), getVersion(envelope));
    }
    ...
    public void indicatestatement(final JsonEnvelope envelope) throws EventStreamException {
        ...
        Stream<Object> events = streamOf(progressionEventFactory.createIndicateEvidenceServed(envelope));
    ...
    public void indicateAllStatementsIdentified(final JsonEnvelope envelope) throws EventStreamException {
        Stream<Object> events = streamOf(progressionEventFactory.createAllStatementsIdentified(envelope));
        EventStream eventStream = eventSource.getStreamById(getCaseProgressionId(envelope));
        eventStream.appendAfter(events.map(enveloper.withMetadataFrom(envelope)), getVersion(envelope));
    }
    ...
    public void indicateAllStatementsServed(final JsonEnvelope envelope) throws EventStreamException {
        Stream<Object> events = streamOf(progressionEventFactory.createAllStatementsServed(envelope));
        EventStream eventStream = eventSource.getStreamById(getCaseProgressionId(envelope));
        eventStream.appendAfter(events.map(enveloper.withMetadataFrom(envelope)), getVersion(envelope));
    }
