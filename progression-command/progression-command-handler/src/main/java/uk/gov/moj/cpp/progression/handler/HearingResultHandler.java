...
public class HearingResultHandler {
    ...
    public void handle(final Envelope<HearingResult> envelope) throws EventStreamException {
        ...
        final Stream<Object> events = hearingAggregate.saveHearingResult(hearingResult.getHearing(), hearingResult.getSharedTime(), hearingResult.getShadowListedOffences());
