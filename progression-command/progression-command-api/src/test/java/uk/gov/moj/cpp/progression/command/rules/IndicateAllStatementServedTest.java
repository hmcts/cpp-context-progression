...
public class IndicateAllStatementServedTest extends BaseDroolsAccessControlTest {
    ...
    private static final String MEDIA_TYPE = "progression.command.indicate-all-statements-served";
