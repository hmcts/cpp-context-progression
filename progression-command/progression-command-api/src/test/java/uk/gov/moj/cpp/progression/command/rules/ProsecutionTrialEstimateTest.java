...
public class ProsecutionTrialEstimateTest extends BaseDroolsAccessControlTest {
    ...
    private static final String MEDIA_TYPE = "progression.command.prosecution-trial-estimate";
