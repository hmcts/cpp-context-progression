...
public class ExtendHearingApiTest {
    ...
    @InjectMocks
    private ExtendHearingApi extendHearingApi;
    ...
    public void shouldExtendHearing() {
        ...
        when(enveloper.withMetadataFrom(command, "progression.command.extend-hearing"))
                .thenReturn(function);
        when(function.apply(any())).thenReturn(commandEnvelope);
        extendHearingApi.handle(command);
