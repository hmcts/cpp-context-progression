...
public class PrepareForSentenceHearingTest extends ProgressionRuleExecutor {

    private static final String[] ACTION_GROUPS =
                    new String[] {"Listing Officers", "Judiciary", "Case Officer"};

    private static final String[] ALLOWED_USER_GROUPS =
                    new String[] {"Listing Officers", "Judiciary", "Case Officer"};

    private static final String MEDIA_TYPE = "progression.command.prepare-for-sentence-hearing";
