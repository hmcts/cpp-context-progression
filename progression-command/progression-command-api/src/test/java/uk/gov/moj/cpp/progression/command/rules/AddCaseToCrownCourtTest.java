...
public class AddCaseToCrownCourtTest extends ProgressionRuleExecutor {
    ...
    private static final String MEDIA_TYPE = "progression.command.add-case-to-crown-court";
