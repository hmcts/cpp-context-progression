...
public class NoMoreDefendantInfoRequiredTest extends ProgressionRuleExecutor {

    private static final String[] ALLOWED_USER_GROUPS = new String[] {"Judiciary", "Case Officer"};

    private static final String MEDIA_TYPE = "progression.command.no-more-information-required";

    private static final String[] ACTION_GROUPS = new String[] {"Judiciary", "Case Officer"};
